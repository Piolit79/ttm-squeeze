/**
 * TTM Squeeze Pro — TypeScript port of the validated Python implementation.
 * Pure functions, zero dependencies, O(n) where possible.
 *
 * Dot colors:  orange=high compression, red=mid, black=low, green=fired
 * Mom colors:  cyan=↑+, blue=↓+, yellow=↓−, red_m=↑−
 */
...
export function computeTTM(
  bars: OHLCBar[],
  opts = { length: 20, bbMult: 2.0, kcHigh: 1.0, kcMid: 1.5, kcLow: 2.0 },
): IndicatorBar[] {
  ...
  // Keltner Channels (EMA mid + Wilder ATR)
